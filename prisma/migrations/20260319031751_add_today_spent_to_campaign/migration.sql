...
INSERT INTO "new_campaigns" ("advertiser_id", "budget", "daily_budget", "end_date", "id", "name", "spent", "start_date") SELECT "advertiser_id", "budget", "daily_budget", "end_date", "id", "name", "spent", "start_date" FROM "campaigns";
